...
(function () {
  ...
  abp.message.confirm = function (
    ...
    options.title = title
      ? title
      : abp.localization.abpWeb("Bạn có chắc chắn ?");
    options.icon = "warning";
    options.confirmButtonText =
      options.confirmButtonText || abp.localization.abpWeb("Đồng ý");
    options.cancelButtonText =
      options.cancelButtonText || abp.localization.abpWeb("Hủy bỏ");
