...
namespace SunnyGardenCoffee.AppManager
{
    public class UnitOfWorkDapper: IUnitOfWorkDapper
    {
        ...
        public async Task<TK> QueryFirstOrDefaultAsync<TK>(string query, object param = null, int? commandTimeout = null, CommandType? commandType = CommandType.Text)
        {
            return await Connection.QueryFirstOrDefaultAsync<TK>(query, param, transaction: _transaction ?? null, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        public async Task<TK> QuerySingleOrDefaultAsync<TK>(string query, object param = null, int? commandTimeout = null, CommandType? commandType = CommandType.Text)
        {
            return await Connection.QuerySingleOrDefaultAsync<TK>(query, param, transaction: _transaction ?? null, commandTimeout: commandTimeout, commandType: commandType);
        }
